...
Keks::Application.configure do
  ...
  config.assets.precompile += %w( users.css admins.css die-ie-die.css users.js admins.js jquery.uix.multiselect.js highcharts.js )
  ...
  config.action_mailer.default_url_options = { :host => "keks.mathi.uni-heidelberg.de", :protocol => "https:" }
